...
@hydra.main(config_path='config/train_SURF.yaml', strict=True)
def main(cfg):
    entity_name = ''
    wandb.init(project="sdp", config=utils.flatten_dict(dict(cfg)), name=f'surf_{cfg.env}_{cfg.max_feedback}_{cfg.seed}',
