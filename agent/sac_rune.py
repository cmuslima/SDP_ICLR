...
class SACAgent_Rune(Agent):
    ...
    def __init__(self, obs_dim, action_dim, action_range, device, critic_cfg,
        ...
        #print('passing init of critic')
        self.critic_target = hydra.utils.instantiate(critic_cfg).to(
            self.device)
        #print('passing init of critic target 1')

        self.critic_target.load_state_dict(self.critic.state_dict())
        #print('passing init of critic target 2')

        self.actor = hydra.utils.instantiate(actor_cfg).to(self.device)
        #print('passing init of actor')
