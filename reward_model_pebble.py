...
class RewardModel:
    def __init__(self, ds, da, 
                 ...
                 env_maker=None, max_size=100, activation='tanh', init='default', capacity=5e5,  
                 large_batch=1, label_margin=0.0, 
                 teacher_beta=-1, teacher_gamma=1, 
                 teacher_eps_mistake=0, 
                 teacher_eps_skip=0, 
                 teacher_eps_equal=0, device = 'device'):
        ...
        self.origin_reward_batch = reward_batch
        ...
        self.weight_norm = dict()

    def update_inputs(self,prior_amount):
        """This is to fix a bug b/c I gathered 50000 + 1 transitions. B/c I gathered a data point in a 
        new trajectory, it caused some problems."""
        traj_len = self.inputs[0].shape[0]
        num = int((prior_amount-1)/traj_len)  
        if prior_amount % 10 != 0:
            self.targets[num] = []
            self.inputs[num] = []
    ...
    def change_batch(self, new_frac):
        self.reward_batch = int(self.origin_reward_batch*new_frac)
    
    def set_batch(self, new_batch):
        self.reward_batch = int(new_batch)
    ...
    def get_queries(self, reward_batch=20):
        ...
        print('len_traj', len_traj, 'max_len', max_len, 'number of targets', len(self.targets))
    ...
    def kcenter_sampling(self):
        ...
        # get queries
        num_init = self.reward_batch*self.large_batch
        sa_t_1, sa_t_2, r_t_1, r_t_2 =  self.get_queries(
            reward_batch=num_init)
        ...
        selected_index = KCenterGreedy(temp_sa, tot_sa, self.reward_batch)
    ...
    def disagreement_sampling(self):
        ...
        # get queries
        sa_t_1, sa_t_2, r_t_1, r_t_2 =  self.get_queries(
            reward_batch=self.reward_batch*self.large_batch)
        
        # get final queries based on uncertainty
        _, disagree = self.get_rank_probability(sa_t_1, sa_t_2)
        top_k_index = (-disagree).argsort()[:self.reward_batch]
        r_t_1, sa_t_1 = r_t_1[top_k_index], sa_t_1[top_k_index]
        r_t_2, sa_t_2 = r_t_2[top_k_index], sa_t_2[top_k_index]        
    ...
    def entropy_sampling(self):
        ...
        top_k_index = (-entropy).argsort()[:self.reward_batch]
        r_t_1, sa_t_1 = r_t_1[top_k_index], sa_t_1[top_k_index]
        r_t_2, sa_t_2 = r_t_2[top_k_index], sa_t_2[top_k_index]
    ...
    def get_parameters(self):
        ...
        print(len(params))
        combined_params = torch.cat(params, axis=0 )
