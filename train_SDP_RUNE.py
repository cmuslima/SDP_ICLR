...
from replay_buffer_rune import ReplayBuffer
from reward_model_rune import RewardModel
...
class Workspace(object):
    def __init__(self, cfg):
        ...
        prior_replay_buffer = utils.get_data(f'{self.cfg.base_dir}/{self.cfg.prior_data_path}_seed{self.cfg.seed}/replay_buffer')
        self.replay_buffer.copy_over_buffer(prior_replay_buffer, self.reward_model)
...
@hydra.main(config_path='config/train_sdp_rune.yaml', strict=True)
def main(cfg):
    entity_name = ''
    wandb.init(project="sdp", config=utils.flatten_dict(dict(cfg)), name=f'sdp_rune_{cfg.env}_{cfg.max_feedback}_{cfg.seed}',
