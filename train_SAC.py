...
class Workspace(object):
    def __init__(self, cfg):
        ...
        #print('self.env._max_episode_steps', self.env._max_episode_steps)
        #input('wait')
        # no relabel
    ...
    def run(self):
        ...
        while self.step < self.cfg.num_train_steps:
            ...
            #print('done after float operation', done)
            done_no_max = 0 if episode_step + 1 == self.env._max_episode_steps else done
            #print('done after if statment', done)
            #print('done_no_max', done)
            episode_reward += reward
