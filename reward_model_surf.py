...
from reward_model_pebble import RewardModel, gen_net, KCenterGreedy



class RewardModelSurf(RewardModel):
    def __init__(self, ds, da, 
                 ensemble_size=3, lr=3e-4, reward_batch = 128, size_segment=1, 
    ...
    def kcenter_sampling(self):
        ...
        u_sa_t_1, u_sa_t_2, u_r_t_1, u_r_t_2 =  self.get_queries(reward_batch=self.reward_batch*self.inv_label_ratio)
