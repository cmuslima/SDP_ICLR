...
class RewardModel:
    def __init__(self, ds, da, 
                 ...
                 teacher_eps_skip=0, 
                 teacher_eps_equal=0, device='cuda'):
    ...
    def set_teacher_thres_equal(self, new_margin):
        #print('teacher_thres_equal before', self.teacher_thres_equal)
        self.teacher_thres_equal = new_margin * self.teacher_eps_equal
        #print('updating teacher_thres_equal', self.teacher_thres_equal)
    ...
    def get_queries(self, mb_size=20):
        ...
        #print(np.shape(self.inputs), np.shape(self.targets))
       ...
       # print("shape of sa_t_1", np.shape(sa_t_1))
        ...
        #print('time time_index_1', time_index_1)
    ...
    def uniform_sampling(self, mb_size=None):
