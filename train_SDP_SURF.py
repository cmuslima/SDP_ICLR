...
from reward_model_surf import RewardModelSurf
...
class Workspace(object):
    def __init__(self, cfg):
        ...
        self.reward_model = RewardModelSurf(
...
@hydra.main(config_path='config/train_sdp_surf.yaml', strict=True)
def main(cfg):
    entity_name = ''
    wandb.init(project="sdp", config=utils.flatten_dict(dict(cfg)), name=f'sdp_surf_{cfg.env}_{cfg.max_feedback}_{cfg.seed}',
